...
data_dirs = ['C:/Users/shimon/Documents/Visual Studio 2015/Projects/16.10.18_batch +-180/','C:/Users/shimon/Documents/Visual Studio 2015/Projects/21.11.18_batch +-180/']
...
def ang_diff(angle1, angle2):
    return tf.minimum(tf.abs(angle1 - angle2), 360 - tf.abs(angle1 - angle2))
...
def inference(images,device,is_training):
  ...
  with tf.device(device):
   ...
   # conv5_5
    ...
    with tf.variable_scope('softmax_linear') as scope:
          ...
          #softmax_linear = tf.abs(tf.nn.bias_add(tf.matmul(data_dropout, weights), biases))
    ...
    #softmax_linear = tf.nn.softmax(fc3)
